...
const ProfileIconActive = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M16 7C16 9.209 14.209 11 12 11C9.791 11 8 9.209 8 7C8 4.791 9.791 3 12 3C14.209 3 16 4.791 16 7Z" stroke="#F5F0E8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M12 14C8.134 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="#F5F0E8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const ProfileScreen = ({ profileTestingEnabled, localProfileRole, onRoleChange, onGoHome, onGoMap }: ProfileScreenProps) => {
  return (
        ...
        <div className="flex flex-col gap-[16px] px-[24px]">
          <div
            ...
            style={{
              borderRadius: 20,
              padding: 24,
              backgroundImage: "linear-gradient(135deg, #1e4a48 0%, #266058 42%, #2e7a6e 100%)",
              boxShadow: "#1E5C5A40 0px 4px 16px, #1E5C5A26 0px 1px 4px"
            }}
          >
            <div className="qahal-display" style={{ fontSize: 22, color: "#F5F0E8", fontWeight: 700 }}>
              Your Qahal Journey
            </div>
            <p style={{ fontSize: 13, color: "#F5F0E8CC" }}>
              This screen is ready for your new profile blocks, badges, and personal settings.
            </p>
          </div>
          ...
          {profileTestingEnabled ? (
            <div
              ...
              style={{
                ...
                boxShadow: "#1C252514 0px 6px 18px"
              }}
            >
              <div className="qahal-display" style={{ fontSize: 20, color: "#1C2526", fontWeight: 600 }}>
                Testing Profile Role
              </div>
              <p style={{ fontSize: 13, color: "#5A5A52" }}>
                Testing environment only. Choose how profile membership should behave.
              </p>
              <select
              ...
              <p style={{ fontSize: 12, color: "#6B7280" }}>
                {roleOptions.find((option) => option.value === localProfileRole)?.description}
              </p>
            </div>
          ) : null}
        </div>
